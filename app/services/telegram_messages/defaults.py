DEFAULT_TELEGRAM_TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "progress.take_step_1": {"value": "⏳ Генерация снимка [🟩🟩⬜⬜⬜] 1/3", "category": "progress", "description": "Прогресс снимка: шаг 1/3 с эмодзи-полоской."},
    "progress.take_step_2": {"value": "⏳ Генерация снимка [🟩🟩🟩🟩⬜] 2/3", "category": "progress", "description": "Прогресс снимка: шаг 2/3 с эмодзи-полоской."},
    "progress.take_step_3": {"value": "⏳ Генерация снимка [🟩🟩🟩🟩🟩] 3/3", "category": "progress", "description": "Прогресс снимка: шаг 3/3 с эмодзи-полоской."},
